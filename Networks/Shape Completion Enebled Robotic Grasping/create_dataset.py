...
path_root = '/media/leo/Datos/Varley Datasets/ycb_dataset/ycb'#'/media/leo/Data/ycb_dataset/ycb'#'/media/leo/Datos1/Respaldo/Old/Descargas/grasp_database/grasp_database'
chdir(path_root)
...
f = open('/home/leo/Datasets/dic_x_ycb_master_data.pkl','wb')
pickle.dump(dic_x,f)
f.close

#directorios con etiquetas de entrenamiento
f = open('/home/leo/Datasets/dic_y_ycb_master_data.pkl','wb')
pickle.dump(dic_y,f)
f.close


#directorios con ejemplos de pc
f = open('/home/leo/Datasets/dic_pd_ycb_master_data.pkl','wb')
