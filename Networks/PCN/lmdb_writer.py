...
class pcd_df(DataFlow):
    ...
    def get_data(self):
        for model_id in model_list:
            complete = read_pcd(self.complete_dir+'/'+ model_id+'.pcd')
            partial = read_pcd(self.partial_dir+'/'+ model_id+'.pcd' )
...
if __name__ == '__main__':
    ...
    print(args.partial_dir, args.complete_dir,args.output_path)
